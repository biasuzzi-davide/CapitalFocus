...
{
    ui->setupUi(this);
    // Inizializza la pagina di dettaglio corretta
...
void CreatePlaceWidget::setController(PlaceController *c)
{
    ...
    // Collega i segnali dei bottoni e della combobox al controller
...
// Getter e Setter specifici per Disco
...
// Getter e Setter specifici per Cafe
...
// Getter e Setter specifici per Restaurant
...
// Getter e Setter specifici per Mall
...
// Getter e Setter specifici per LocalMarket
...
// Getter e Setter specifici per Museum
...
// Getter e Setter specifici per Monument
...
// Metodi per la gestione degli orari di apertura
...
// Getter e Setter specifici per Entertainment (Disco)
...
// Getter e Setter specifici per Entertainment (Panoramic)
...
// Getter e Setter specifici per Food (Restaurant)
...
// Getter e Setter specifici per Food (Cafe)
...
// Getter e Setter specifici per Culture (Museum)
...
// Getter e Setter specifici per Culture (Monument)
...
// Getter e Setter specifici per Shopping (Market)
...
// Getter e Setter specifici per Shopping (Mall)
...
// Restituisce l'indice del tipo selezionato
int CreatePlaceWidget::getTypeIndex() const {
    return ui->comboBoxType->currentIndex();
}

// Imposta la modalità di modifica (il bottone diventa "Save")
...
// Controlla se è attiva la modalità di modifica
...
void CreatePlaceWidget::resetFields()
{
    ...
    // Torna alla modalità "crea" e alla prima pagina di dettaglio
    setEditing(false);
